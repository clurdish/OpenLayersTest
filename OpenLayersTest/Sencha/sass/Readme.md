...
folder are mapped to the application's root namespace, 'OpenLayersTest'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "OpenLayersTest"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'OpenLayersTest' in the same way
as `"OpenLayersTest/sass/src"`.
